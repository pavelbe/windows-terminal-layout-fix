...
Команды HCA `wt`, `atreno` и другие проектные алиасы пока адресуют **установленный
Preview**, а не эту portable-копию. Их маршрутизация хранится в HCA отдельно.
...
- Сравнение stock/fix с полностью одинаковым текущим конфигом и полный UI-регресс
  ещё не выполнены. Удвоение кириллицы в Codex наблюдалось в обеих сборках и
  остаётся отдельной диагностикой; этот патч не заявлен его исправлением.
